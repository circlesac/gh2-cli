...
const REPO = "circlesac/gh2-cli";

const PLATFORMS = {
  "darwin-x64": { artifact: "gh2-darwin-x64", ext: ".tar.gz" },
  "darwin-arm64": { artifact: "gh2-darwin-arm64", ext: ".tar.gz" },
  "linux-x64": { artifact: "gh2-linux-x64", ext: ".tar.gz" },
  "linux-arm64": { artifact: "gh2-linux-arm64", ext: ".tar.gz" },
};
...
if (!fs.existsSync(binPath)) {
  ...
  if (version) {
    ...
    console.info(`Downloading gh2 v${version} for ${platform}...`);
